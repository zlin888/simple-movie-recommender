<template>
  <div class="container">
    ...
    <div class="main-title">
      <!-- icon -->
      <div>
        <img src="@/assets/for_you_48.png" />
      </div>
      <!-- word -->
      <div style="margin-left:20px">For You</div>
      <!-- refresh button -->
...
import { recommendMovies } from "@/api/recommendation";
...
export default {
  ...
  mounted: function() {
    recommendMovies(this.$store.getters["user/id"], 8).then(
      response => {
